...
class TestReviewDocs(unittest.TestCase):
    ...
    def test_pep8_conformance_review(self):
        """Tests to check that models/review.py conforms to PEP8."""
...
class TestReview(unittest.TestCase):
    ...
    def test_is_subclass(self):
        """Tests to check if Review is a subclass of BaseModel"""
        review = Review()
    ...
    def test_place_id_attr(self):
        """Tests to check that Review has attr place_id, and it's an empty string"""
        review = Review()
    ...
    def test_user_id_attr(self):
        """Tests to check that Review has attr user_id, and it's an empty string"""
        review = Review()
    ...
    def test_text_attr(self):
        """Tests to check that Review has attr text, and it's an empty string"""
        review = Review()
