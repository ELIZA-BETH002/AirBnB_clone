...
class TestDBStorageDocs(unittest.TestCase):
    """Tests to check the documentations and style of DBStorage class"""
    @classmethod
    def setUpClass(cls):
    ...
    def test_pep8_conformance_db_storage(self):
        """Test to check that models/engine/db_storage.py conforms to PEP8."""
    ...
    def test_pep8_conformance_test_db_storage(self):
        """Tests to check that tests/test_models/test_db_storage.py conforms to PEP8."""
        pep8s = pep8.StyleGuide(quiet=True)
