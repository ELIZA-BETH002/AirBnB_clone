...
class TestStateDocs(unittest.TestCase):
    ...
    def test_pep8_conformance_state(self):
        """Tests to check that models/state.py conforms to PEP8."""
    ...
    def test_pep8_conformance_test_state(self):
        """Tests to check that tests/test_models/test_state.py conforms to PEP8."""
        pep8s = pep8.StyleGuide(quiet=True)
...
class TestState(unittest.TestCase):
    ...
    def test_is_subclass(self):
        """Tests to check that State is a subclass of BaseModel"""
        state = State()
    ...
    def test_name_attr(self):
        """Tests to check that State has attribute name, and it's as an empty string"""
        state = State()
