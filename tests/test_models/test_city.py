...
class TestCityDocs(unittest.TestCase):
    """Tests to check that the documentation and style of City class"""
    @classmethod
    def setUpClass(cls):
    ...
    def test_pep8_conformance_city(self):
        """Tests to check that models/city.py conforms to PEP8."""
    ...
    def test_pep8_conformance_test_city(self):
        """Tests to check that tests/test_models/test_city.py conforms to PEP8."""
        pep8s = pep8.StyleGuide(quiet=True)
...
class TestCity(unittest.TestCase):
    ...
    def test_name_attr(self):
        """Tests to check that City has attribute name, and it's an empty string"""
        city = City()
    ...
    def test_state_id_attr(self):
        """Tests to check that City has attribute state_id, and it's an empty string"""
        city = City()
